...
:date: (last modification) 2019-08-23T11:56:25.126033
...
class neMESYSClient(SiLA2Client):
    ...
    def __init__(
        ...
        self.ShutdownController_serv_stub = \
    ...
    def Shutdown(self,
        ...
        try:
            ...
            response = self.ShutdownController_serv_stub.Shutdown(parameter)
    ...
    def Shutdown_Info(self,
        ...
        try:
            response = self.ShutdownController_serv_stub.Shutdown_Info(uuid)
    ...
    def Shutdown_Result(self,
        ...
        try:
            response = self.ShutdownController_serv_stub.Shutdown_Result(uuid)
    ...
    def Subscribe_VolumeUnit(self) -> PumpUnitController_pb2.Subscribe_VolumeUnit_Responses:
        ...
        return response
    def Subscribe_MaxSyringeFillLevel(self) -> PumpFluidDosingService_pb2.Subscribe_MaxSyringeFillLevel_Responses:
        ...
        try:
            response = self.PumpFluidDosingService_serv_stub.Subscribe_MaxSyringeFillLevel(
    ...
    def Subscribe_SyringeFillLevel(self) -> PumpFluidDosingService_pb2.Subscribe_SyringeFillLevel_Responses:
        ...
        return response
    def Subscribe_MaxFlowRate(self) -> PumpFluidDosingService_pb2.Subscribe_MaxFlowRate_Responses:
        ...
        try:
            response = self.PumpFluidDosingService_serv_stub.Subscribe_MaxFlowRate(
