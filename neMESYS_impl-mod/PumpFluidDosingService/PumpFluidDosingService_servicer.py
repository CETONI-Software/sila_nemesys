...
:date: (last modification) 2019-08-27T07:22:08.550861
...
class PumpFluidDosingService(pb2_grpc.PumpFluidDosingServiceServicer):
    ...
    def SetFillLevel_Info(self, request, context) -> fwpb2.ExecutionInfo:
        ...
        except neMESYS_errors.SiLAFrameworkError as err:
            err.raise_rpc_error(context)
            return None
    ...
    def DoseVolume(self, request, context) -> fwpb2.CommandConfirmation:
        ...
        except (neMESYS_errors.VolumeOutOfRangeError, neMESYS_errors.DeviceError) as err:
            self.implementation.StopDosage(None, None)
    ...
    def GenerateFlow(self, request, context) -> fwpb2.CommandConfirmation:
        ...
        except (neMESYS_errors.FlowRateOutOfRangeError, neMESYS_errors.DeviceError) as err:
            self.implementation.StopDosage(None, None)
            if isinstance(err, neMESYS_errors.DeviceError):
                err = neMESYS_errors.QmixSDKError(err)
            err.raise_rpc_error(context)
