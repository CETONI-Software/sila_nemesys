...
:date: (last modification) 2019-07-17T12:52:09.182993
...
class PumpFluidDosingServiceSimulation:
    ...
    def Subscribe_MaxSyringeFillLevel(self, request, context) -> pb2.Subscribe_MaxSyringeFillLevel_Responses:
        ...
        # initialise the return value
        return_value: pb2.Subscribe_MaxSyringeFillLevel_Responses = None
    
        # create the default value
        if return_value is None:
            return_value = pb2.Subscribe_MaxSyringeFillLevel_Responses(
    ...
    def Subscribe_MaxFlowRate(self, request, context) -> pb2.Subscribe_MaxFlowRate_Responses:
        ...
        # initialise the return value
        return_value: pb2.Subscribe_MaxFlowRate_Responses = None
    
        # create the default value
        if return_value is None:
            return_value = pb2.Subscribe_MaxFlowRate_Responses(
