...
class ValvePositionControllerReal:
    ...
    def SwitchToPosition(self, request, context) -> pb2.SwitchToPosition_Responses:
        ...
        # TODO:
        #   Add implementation of Real for command SwitchToPosition here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.SwitchToPosition_Responses(
    ...
    def TogglePosition(self, request, context) -> pb2.TogglePosition_Responses:
        ...
        # TODO:
        #   Add implementation of Real for command TogglePosition here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.TogglePosition_Responses(
    ...
    def Get_NumberOfPositions(self, request, context) -> pb2.Get_NumberOfPositions_Responses:
        ...
        # initialise the return value
        return_value: pb2.Get_NumberOfPositions_Responses = None
    
        # TODO:
        #   Add implementation of Real for property NumberOfPositions here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.Get_NumberOfPositions_Responses(
    ...
    def Subscribe_Position(self, request, context) -> pb2.Subscribe_Position_Responses:
        ...
        # initialise the return value
        return_value: pb2.Subscribe_Position_Responses = None
    
        # create the default value
        if return_value is None:
            return_value = pb2.Subscribe_Position_Responses(
