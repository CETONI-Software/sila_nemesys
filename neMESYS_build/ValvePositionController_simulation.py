...
class ValvePositionControllerSimulation():
    """ ValvePositionControllerSimulation - Allows to specify a certain logical position for a valve. The CurrentPosition property can be querried at any time to obtain the current valve position. """
    def __init__ (self):
