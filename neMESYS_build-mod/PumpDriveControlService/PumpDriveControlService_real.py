...
:date: (last modification) 2019-07-16T11:11:31.282215
...
class PumpDriveControlServiceReal:
    ...
    def InitializePumpDrive(self, request, context) -> pb2.InitializePumpDrive_Responses:
        ...
        # TODO:
        #   Add implementation of Real for command InitializePumpDrive here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.InitializePumpDrive_Responses(
    ...
    def EnablePumpDrive(self, request, context) -> pb2.EnablePumpDrive_Responses:
        ...
        # TODO:
        #   Add implementation of Real for command EnablePumpDrive here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.EnablePumpDrive_Responses(
    ...
    def DisablePumpDrive(self, request, context) -> pb2.DisablePumpDrive_Responses:
        ...
        # TODO:
        #   Add implementation of Real for command DisablePumpDrive here and write the resulting response
        #   in return_value
    
        # fallback to default
        if return_value is None:
            return_value = pb2.DisablePumpDrive_Responses(
    ...
    def Subscribe_PumpDriveState(self, request, context) -> pb2.Subscribe_PumpDriveState_Responses:
        ...
        # initialise the return value
        return_value: pb2.Subscribe_PumpDriveState_Responses = None
    
        # create the default value
        if return_value is None:
            return_value = pb2.Subscribe_PumpDriveState_Responses(
        ...
        while True:
            # TODO:
            #   Add implementation of Real for property PumpDriveState here and write the resulting
    ...
    def Subscribe_FaultState(self, request, context) -> pb2.Subscribe_FaultState_Responses:
        ...
        # initialise the return value
        return_value: pb2.Subscribe_FaultState_Responses = None
    
        # create the default value
        if return_value is None:
            return_value = pb2.Subscribe_FaultState_Responses(
        ...
        while True:
            # TODO:
            #   Add implementation of Real for property FaultState here and write the resulting
            #   response in return_value
